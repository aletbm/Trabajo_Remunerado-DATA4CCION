...
23 países de América Latina y el Caribe, seleccionados por disponibilidad de datos y diversidad subregional:

- Cono Sur: Argentina, Brasil, Chile, Uruguay, Paraguay
...
- Caribe: Cuba, República Dominicana, Haití, Jamaica, Puerto Rico, Trinidad y Tobago, México
...
|--------|-------------|-----|
| CEPAL | Tiempo de trabajo remunerado y no remunerado, población fuera del mercado laboral | https://oig.cepal.org/es |
| ILOSTAT (OIT) | Ocupación en actividades de cuidado por sexo y edad, tasa de desocupación | https://ilostat.ilo.org/es/data |
| ITU | Uso de internet por país, edad y género | https://www.itu.int/en/ITU-D/Statistics/Pages/stat/default.aspx |
| Banco Mundial | Porcentaje de personas que usan internet diariamente | https://data360.worldbank.org/en/indicator/ITU_DH_INT_USR_DAY |
